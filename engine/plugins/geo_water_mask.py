...
@vision_node(
    ...
    params=[
        ...
        {'id': 'nir_band',   'type': 'int',   'default': 4,   'min': 1, 'max': 20,
         'label': 'NIR band (NDWI only)',  'show_if': {'param': 'index', 'value': 0}},
        {'id': 'swir_band',  'type': 'int',   'default': 4,   'min': 1, 'max': 20,
         'label': 'SWIR band (MNDWI only)', 'show_if': {'param': 'index', 'value': 1}},
        {'id': 'scl_band',   'type': 'int',   'default': 0,   'min': 0, 'max': 20,
         'label': 'SCL cloud band (0=off)', 'show_if': {'param': 'index', 'value': 1}},
