...
@vision_node(
    ...
    params=[
        ...
        {'id': '_sec_formula_cfg', 'label': 'Formula Config', 'type': 'section'},
...
@vision_node(
    ...
    params=[
        ...
        {'id': '_sec_functions', 'label': 'Functions', 'type': 'section'},
        ...
        {'id': '_sec_control_gp', 'label': 'Control', 'type': 'section'},
