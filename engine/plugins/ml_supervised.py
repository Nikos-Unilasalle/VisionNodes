...
@vision_node(
    ...
    params=[
        {'id': '_sec_data_lr', 'label': 'Data', 'type': 'section'},
        ...
        {'id': '_sec_export_lr', 'label': 'Export', 'type': 'section'},
        *_EXPORT_PARAMS,
    ],
    resizable=True,
    min_width=320,
...
@vision_node(
    ...
    params=[
        {'id': '_sec_data_svm', 'label': 'Data', 'type': 'section'},
        {'id': 'features',     'label': 'Features (blank = all numeric)', 'type': 'string', 'default': ''},
        {'id': 'target',       'label': 'Target column',                  'type': 'string', 'default': ''},
        {'id': '_sec_model_svm', 'label': 'Model Config', 'type': 'section'},
        ...
        {'id': '_sec_display_svm', 'label': 'Display', 'type': 'section'},
        ...
        {'id': '_sec_export_svm', 'label': 'Export', 'type': 'section'},
        *_EXPORT_PARAMS,
    ],
    resizable=True,
    min_width=320,
...
@vision_node(
    ...
    params=[
        {'id': '_sec_data_dt', 'label': 'Data', 'type': 'section'},
        {'id': 'features',        'label': 'Features (blank = all numeric)', 'type': 'string', 'default': ''},
        {'id': 'target',          'label': 'Target column',                  'type': 'string', 'default': ''},
        {'id': '_sec_model_dt', 'label': 'Model Config', 'type': 'section'},
        ...
        {'id': '_sec_export_dt', 'label': 'Export', 'type': 'section'},
        *_EXPORT_PARAMS,
    ],
    resizable=True,
    min_width=320,
