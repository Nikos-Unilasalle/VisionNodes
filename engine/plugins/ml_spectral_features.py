...
@vision_node(
    ...
    params=[
        {'id': '_sec_cols', 'type': 'section', 'label': 'Column Names'},
        {'id': 'blue_col',   'type': 'string', 'default': 'Blue',  'label': 'Blue'},
        {'id': 'green_col',  'type': 'string', 'default': 'Green', 'label': 'Green'},
        {'id': 'red_col',    'type': 'string', 'default': 'Red',   'label': 'Red'},
        {'id': 'nir_col',    'type': 'string', 'default': 'NIR',   'label': 'NIR'},
        {'id': 'swir1_col',  'type': 'string', 'default': 'SWIR1', 'label': 'SWIR1 (optional)'},
        {'id': 'swir2_col',  'type': 'string', 'default': 'SWIR2', 'label': 'SWIR2 (optional)'},
        {'id': '_sec_ratios', 'type': 'section', 'label': 'Ratios & Logs'},
        {'id': 'add_red_green',  'type': 'bool', 'default': True,  'label': 'Red/Green (turbidity)'},
        {'id': 'add_red_nir',    'type': 'bool', 'default': True,  'label': 'Red/NIR'},
        ...
        {'id': '_sec_indices', 'type': 'section', 'label': 'Spectral Indices'},
        {'id': 'add_ndti',       'type': 'bool', 'default': True,  'label': 'NDTI'},
        {'id': 'add_ndwi',       'type': 'bool', 'default': False, 'label': 'NDWI'},
        {'id': 'add_nir_swir1',  'type': 'bool', 'default': False, 'label': 'NIR/SWIR1'},
        {'id': 'add_red_swir1',  'type': 'bool', 'default': False, 'label': 'Red/SWIR1'},
        {'id': 'add_mndwi',      'type': 'bool', 'default': False, 'label': 'MNDWI'},
        {'id': 'add_nbr',        'type': 'bool', 'default': False, 'label': 'NBR'},
        {'id': 'add_log_swir1',  'type': 'bool', 'default': False, 'label': 'log(SWIR1+1)'},
        {'id': '_sec_custom', 'type': 'section', 'label': 'Custom Expression'},
        {'id': 'custom_expr', 'type': 'string', 'default': '',
         'label': 'Expr (e.g. r/g, log1p(b/r)) — use b,g,r,n'},
