...
@vision_node(
    ...
    params=[
        ...
        {'id': 'add_blue_red',   'type': 'bool', 'default': False, 'label': 'Bleu/Rouge'},
        {'id': 'add_blue_nir',   'type': 'bool', 'default': False, 'label': 'Bleu/NIR'},
        {'id': 'add_ndti',       'type': 'bool', 'default': True,  'label': 'NDTI = (Rouge-Vert)/(Rouge+Vert)'},
        {'id': 'add_ndwi',       'type': 'bool', 'default': False, 'label': 'NDWI = (Vert-NIR)/(Vert+NIR)'},
        {'id': 'add_log_red',    'type': 'bool', 'default': True,  'label': 'log(Rouge+1)'},
        {'id': 'add_log_blue',   'type': 'bool', 'default': False, 'label': 'log(Bleu+1)'},
