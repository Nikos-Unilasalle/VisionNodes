...
@vision_node(
    ...
    params=[
        ...
        {'id': 'class_merge', 'type': 'string', 'default': '',
         'label': 'Class merge (e.g. "90=95" merges Wetland into Mangroves)'},
        {'id': 'class_max_samples', 'type': 'string', 'default': '',
         'label': 'Per-class sample override (e.g. "95=15000,60=8000")'},
        {'id': '_sec_model', 'type': 'section', 'label': 'Model'},
        ...
        {'id': '_sec_info', 'type': 'section', 'label': 'Info'},
