# Introduction — comprendre ce qu'on calcule

Une image, pour une machine, n'est rien d'autre qu'une grille de nombres : à chaque point, une intensité, ou un triplet de couleurs. Là où votre œil reconnaît sans effort un visage, une route, une cellule au microscope, l'ordinateur ne dispose que de ce tableau. La vision par ordinateur est l'art de transformer ce tableau en décision — *ceci est un caractère « O »*, *ce contour passe ici*, *cet objet s'est déplacé de trois pixels vers la droite* — et de le faire de façon assez fiable et assez rapide pour qu'on puisse s'y fier.
