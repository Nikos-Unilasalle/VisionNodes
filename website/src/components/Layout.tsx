...
type Tab = 'home' | 'about' | 'wiki' | 'tutorials' | 'community' | 'gallery' | 'admin' | 'download' | 'privacy' | 'marketplace' | 'agro-root-anatomy' | 'learn' | 'vnpad';
...
const CATEGORY_META: Record<string, { label: string; color: string }> = {
  input:       { label: 'Input',        color: '#facc15' },
  ...
  draw:        { label: 'Draw',         color: '#f472b6' },
  math:        { label: 'Math',         color: '#f87171' },
  signal:      { label: 'Signal',       color: '#a78bfa' },
  text:        { label: 'Text',         color: '#22d3ee' },
  keypoints:   { label: 'Keypoints',    color: '#fb923c' },
  ...
  body:        { label: 'Body',         color: '#c084fc' },
  audio:       { label: 'Audio',        color: '#818cf8' },
  geography:   { label: 'Geography',    color: '#10b981' },
