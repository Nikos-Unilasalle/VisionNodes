...
type Tab = 'home' | 'wiki' | 'tutorials' | 'community' | 'download';
  ...
  <nav className="global-nav">
    <div className="container-lg w-full flex items-center justify-between">
      <div className="flex items-center gap-8">
        <img src="/logo.svg" alt="VN" className="w-4 h-4 brightness-200 opacity-80" />
        <span className="hidden md:block text-white/50 hover:text-white/80 cursor-pointer transition-colors text-xs">Research</span>
        <span className="hidden md:block text-white/50 hover:text-white/80 cursor-pointer transition-colors text-xs">Community</span>
        <span className="hidden md:block text-white/50 hover:text-white/80 cursor-pointer transition-colors text-xs">Open Source</span>
      </div>
    ...
    <nav className="sub-nav">
      <div className="container-lg w-full flex items-center justify-between">
        ...
        <button
          ...
          className="text-[19px] font-semibold tracking-tight text-[var(--text-main)] hover:text-[var(--accent)] transition-colors"
  ...
  <section className="section-full" style={{ paddingTop: '5rem', paddingBottom: '4rem' }}>
    <div className="container-lg text-center">
      ...
      >
        ...
        <h1 className="text-[52px] md:text-[72px] font-normal text-[var(--text-main)] mb-4 leading-none">
          VisionNodes Studio
        </h1>
        ...
        <div className="relative max-w-5xl mx-auto">
          <div className="absolute -inset-4 bg-gradient-to-b from-transparent via-transparent to-[var(--bg-main)] pointer-events-none z-10 bottom-0 h-24" />
          <img
            src="/cover.png"
            alt="VisionNodes Studio interface"
            className="w-full rounded-2xl shadow-[0_24px_80px_rgba(26,25,23,0.18)] border border-[var(--border)]"
          />
        </div>
      </motion.div>
    </div>
        ...
        <div className="relative z-10 p-10 md:p-14">
          ...
          <div className="flex items-center gap-10 flex-wrap">
            ...
            <img
              ...
              style={{ filter: 'invert(40%) sepia(90%) saturate(400%) hue-rotate(40deg) brightness(90%)' }}
            />
          </div>
        </div>
      </motion.div>
...
export { HomePage, GlobalNav, SubNav, NodeCard, PortDot, CATEGORY_META, PORT_COLORS, getLucideIcon, getPortColor };
